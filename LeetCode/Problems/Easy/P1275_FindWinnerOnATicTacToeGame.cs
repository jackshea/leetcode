...
public class P1275_FindWinnerOnATicTacToeGame
{
    public string Tictactoe(int[][] moves)
    {
        ...
        for (var i = 0; i < moves.Length; i++)
        {
            ...
            if (r == c) checkBias1 = board[0, 0] == piece && board[1, 1] == piece && board[2, 2] == piece;

            if (r == 2 - c) checkBias2 = board[0, 2] == piece && board[1, 1] == piece && board[2, 0] == piece;
