...
public class MyHashMap
{
    ...
    private readonly KeyValueNode[] container;
    ...
    public int Get(int key)
    {
        var hashKey = key % MAX_LENGTH;
        var keyValueNode = container[hashKey];
        if (keyValueNode == null) return -1;

        while (keyValueNode != null)
        {
            if (keyValueNode.Key == key) return keyValueNode.Value;
    ...
    public void Remove(int key)
    {
        ...
        if (keyValueNode != null && keyValueNode.Key == key)
        {
            ...
            if (keyValueNode.Next != null) keyValueNode.Next.Pre = null;
        }
        ...
        while (keyValueNode != null)
        {
            if (keyValueNode.Key == key)
            {
                if (keyValueNode.Next != null) keyValueNode.Next.Pre = keyValueNode.Pre;

                if (keyValueNode.Pre != null) keyValueNode.Pre.Next = keyValueNode.Next;
