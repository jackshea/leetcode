...
namespace LeetCode.Problems.Tests
{
    ...
    public class P0724_FindPivotIndexTests
    {
        ...
        {
            var test = new P0724_FindPivotIndex();
            var pivotIndex = test.PivotIndex(new int[] { 1 });
        ...
        {
            var test = new P0724_FindPivotIndex();
            var pivotIndex = test.PivotIndex(new int[] { 1, 1 });
            Assert.AreEqual(-1, pivotIndex);
        }
        ...
        {
            var test = new P0724_FindPivotIndex();
            var pivotIndex = test.PivotIndex(new int[] { 1, 7, 3, 6, 5, 6 });
        ...
        {
            var test = new P0724_FindPivotIndex();
            var pivotIndex = test.PivotIndex(new int[] { 1, 0, 0, 1 });
            Assert.AreEqual(1, pivotIndex);
        }
        ...
        {
            var test = new P0724_FindPivotIndex();
            var pivotIndex = test.PivotIndex(new int[] { 1, 2, 0, 0, 0, 0, 2, 1 });
