...
namespace LeetCode.Problems.Medium.Tests
{
    ...
    public class P0825_FriendsOfAppropriateAgesTests
    {
        ...
        {
            var test = new P0825_FriendsOfAppropriateAges();
            var input = new int[] { 20, 30, 100, 110, 120 };
        ...
        {
            var test = new P0825_FriendsOfAppropriateAges();
            var input = new int[] { 73, 106, 39, 6, 26, 15, 30, 100, 71, 35, 46, 112, 6, 60, 110 };
            Array.Sort(input);
        ...
        {
            var test = new P0825_FriendsOfAppropriateAges();
            var input = new int[] { 118, 14, 7, 63, 103 };
            Array.Sort(input);
            Assert.AreEqual(2, test.NumFriendRequests(input));
        }
    }
